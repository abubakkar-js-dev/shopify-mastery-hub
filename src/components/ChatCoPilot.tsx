        ...
        {isOpen && (
          <motion.div
            ...
            className={cn(
              ...
              isMinimized
                ? "rounded-xl ring-1 ring-brand-primary/20"
                : "rounded-none",
            )}
          >
            {/* Header */}
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-[12px] font-black uppercase tracking-widest leading-none mb-1">
                    AI Co-Pilot
                  </h3>
                  <div className="flex items-center gap-1.5">
                    <span className="w-1.5 h-1.5 bg-brand-primary rounded-full animate-pulse shadow-[0_0_8px_rgba(149,255,0,0.8)]" />
                    <span className="text-[9px] font-mono text-white/40 uppercase tracking-tighter italic">
                      L-{lesson.order} Online
                    </span>
                  </div>
                </div>
              </div>
                ...
                <div className="p-4 bg-brand-bg/80 backdrop-blur-md border-t border-white/10">
                  ...
                  <div className="mt-3 flex justify-between items-center px-1">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-[9px] text-brand-primary/40 uppercase tracking-widest font-mono italic">
