      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-[#0F0F0F] border border-white/10 p-8 text-center group">
            ...
            <h3 className="text-xl font-black uppercase tracking-tighter italic truncate">
              {profile.displayName}
            </h3>
            <p className="text-[10px] text-white/40 uppercase tracking-[0.2em] mt-2">
              Level {Math.floor(profile.completedLessons.length / 5) + 1}{" "}
              Learner
            </p>
          </div>
        ...
        <div className="lg:col-span-2">
          <form
            ...
            className="bg-[#0F0F0F] border border-white/10 p-8 md:p-10 space-y-8"
          >
            <div className="space-y-6">
              <div className="space-y-3">
                ...
                <p className="text-[9px] text-white/20 uppercase tracking-widest leading-relaxed">
                  This identity will be visible across the platform, including
                  the terminal logs and leaderboards.
                </p>
              </div>
            </div>
          ...
          <div className="mt-10 p-8 border border-dashed border-white/10">
            ...
            <p className="text-xs text-white/30 leading-relaxed uppercase tracking-tight">
              To update your email or reset your credentials, please utilize the
              primary authentication gateway. Sensitive data modifications
